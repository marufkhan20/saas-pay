      ...
      <div className="container">
        <div className="flex items-center gap-10">
          <div className="w-full">
            <h2 className="text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] lg:leading-[72px] text-white lg:w-[70%]">
        ...
        <div className="mt-5">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-[30px] mt-6">
